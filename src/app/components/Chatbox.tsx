...
const Chatbox = ({ onRoutineGenerated }: any) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 w-100 h-250 bg-white border border-gray-300 rounded-lg shadow-lg p-4 flex flex-col">
      <Box
        width="100%"
        height="100%"
        display="flex"
